            ...
            <form method="POST" action="{{ route('users.store') }}"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input type="email" id="email" name="email" :value="old('email')" required class="mt-1 block w-full" />
                    ...
                    <div>
                        ...
                        <x-text-input type="password" id="password" name="password" required class="mt-1 block w-full" />
                        <x-input-error :messages="$errors->get('password')" class="mt-1" />
                    </div>
                    <div>
                        <x-input-label for="password_confirmation" value="Confirm Password *" />
                        <x-text-input type="password" id="password_confirmation" name="password_confirmation" required class="mt-1 block w-full" />
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-2">
                    ...
                    <button class="px-4 py-2 text-sm bg-indigo-600 hover:bg-indigo-700 text-white rounded-md">Create User</button>
                </div>
            </form>
        </div>
    </div>
